...
| ~~`{{HOURS}}`~~ | 0 | **Done** — 11am&ndash;9pm Monday to Saturday, closed Sunday. Also in `openingHoursSpecification` on all four pages. The sticky island computes today's line from the day of the week, so Sunday reads "Closed" with no manual edit. |
